...
<footer className="bg-black text-yellow-50">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <a href="" className="flex items-center ">
                  ...
                  <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">LuxeWardrobe</span>
              </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul className=" text-yellow-50 font-medium">
                      <li className="mb-4">
                          <a href="" className="hover:underline">LuxeWardrobe</a>
                      </li>
                      <li className="mb-4">
      ...
      <div className="sm:flex sm:items-center sm:justify-center">
          <span className="text-lg  sm:text-center text-yellow-50">© 2023 <a href="" className="hover:underline">LuxeWardrobe™</a>. All Rights Reserved.
          </span>
