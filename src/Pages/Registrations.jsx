...
const Registrations = () => {
  ...
  .then((results) => {
    ...
    fetch("https://fashion-and-apparel-shop-server-6ol0g5b2m-israt-jahans-projects.vercel.app/users", {
      method: "POST",
      headers: {
  ...
  return (
    <div className="mx-auto mb-16 ">
      <div className="mx-auto md:w-1/2 mt-7 mb-2">
        <h3 className="text-3xl mb-4 pt-2 text-center text-red-300 font-bold">
        ...
        <form onSubmit={handelSubmit}>
          ...
          <br />
          <button
            className="mb-4 w-full bg-red-600  rounded-lg py-2  px-4"
            type="submit"
            value="Register"
          >
            Registration{" "}
